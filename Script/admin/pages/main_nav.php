        ...
        <div class="content-side">
            <ul class="nav-main">
                <li class="nav-main-item">
                    <a class="nav-main-link <?php if ($_GET['page'] == "dashboard") {
                                                print ' active ';
                ...
                <li class="nav-main-item">
                    <a class="nav-main-link <?php if ($_GET['page'] == "categories") {
                                                print ' active ';
                ...
                <li class="nav-main-item">
                    <a class="nav-main-link <?php if ($_GET['page'] == "applications") {
                                                print ' active ';
                                            } ?>" href="admin?page=applications">
                        <i class="nav-main-link-icon fa fa-person"></i>
                        <span class="nav-main-link-name">Policy Holders</span>
                    </a>
                </li>
                <li class="nav-main-item">
                    <a class="nav-main-link <?php if ($_GET['page'] == "tickets") {
                                                print ' active ';
                                            } ?>" href="admin?page=tickets">
                ...
                <li class="nav-main-item">
                    <a class="nav-main-link <?php if ($_GET['page'] == "report_tools") {
                                                print ' active ';
                                            } ?>" href="admin?page=report_tools">
                ...
                <li class="nav-main-item">
                    <a class="nav-main-link <?php if ($_GET['page'] == "settings") {
                                                print ' active ';
