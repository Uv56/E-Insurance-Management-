...
<head>
    ...
    <?php if (Theme !== "") {
        print '<link rel="stylesheet" id="css-theme" href="assets/css/themes/' . Theme . '">';
    } ?>
</head>
                                                        ...
                                                        <div class="col-sm-9">
                                                            <select name="timezone" required class="form-control form-control-alt">
                                                                ...
                                                                try {
                                                                    ...
                                                                    foreach ($result as $row) {
                                                                ?>
                                                                        <option <?php if (WBTimezone == $row[2]) {
                                                                                    print ' selected ';
                                                                                } ?> value="<?php echo $row[2]; ?>"><?php echo $row[2]; ?></option>
                                                                <?php
                                                                    }
                                                                } catch (PDOException $e) {
                                                                    echo "Connection failed: " . $e->getMessage();
                                                    ...
                                                    <div class="row mb-2">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <select name="mail_encryption" required class="form-control form-control-alt">
                                                                <option <?php if ($mymail_sec == "tls") {
                                                                            print ' selected ';
                                                                        } ?> value="tls">TLS</option>
                                                                <option <?php if ($mymail_sec == "ssl") {
                                                                            print ' selected ';
                                                    ...
                                                    <div class="mb-2">
                                                        <div class="space-x-2">
                                                            <div class="form-check form-switch form-check-inline">
                                                                <input <?php if ($stripe_switch == "1") {
                                                                            print ' checked ';
                                                                        } ?> name="en" class="form-check-input" type="checkbox" id="example-switch-inline1" name="example-switch-inline1">
                                                                <label class="form-check-label" for="example-switch-inline1">Enable Stripe Payments</label>
                                                            </div>
                                                            <div class="form-check form-switch form-check-inline">
                                                                <input <?php if ($stripe_status == "1") {
                                                                            print ' checked ';
                                                                        } ?> name="status" class="form-check-input" type="checkbox" value="" id="example-switch-inline2" name="example-switch-inline2">
                                                    ...
                                                    <div class="row mb-2">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <select class="form-control form-control-alt" name="sidebar_color" required>
                                                                <option <?php if (Sidebar == "sidebar-light") {
                                                                            print ' selected ';
                                                                        } ?> value="sidebar-light">Light</option>
                                                                <option <?php if (Sidebar == "sidebar-dark") {
                                                                            print ' selected ';
                                                                        } ?> value="sidebar-dark">Dark</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-2">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <select class="form-control form-control-alt" name="sidebar_position" required>
                                                                <option <?php if (Sidebar_Pos == "sidebar-l") {
                                                                            print ' selected ';
                                                                        } ?> value="sidebar-l">Left</option>
                                                                <option <?php if (Sidebar_Pos == "sidebar-r") {
                                                                            print ' selected ';
                                                                        } ?> value="sidebar-r">Right</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-2">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <select class="form-control form-control-alt" name="sidebar_mode" required>
                                                                <option <?php if (Sidebar_Min == "sidebar-mini") {
                                                                            print ' selected ';
                                                                        } ?> value="sidebar-mini">Minimized</option>
                                                                <option <?php if (Sidebar_Min == "") {
                                                                            print ' selected ';
                                                                        } ?> value="">Maxmized</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-2">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <select class="form-control form-control-alt" name="header_color" required>
                                                                <option <?php if (Header == "page-header-light") {
                                                                            print ' selected ';
                                                                        } ?> value="page-header-light">Light</option>
                                                                <option <?php if (Header == "page-header-dark") {
                                                                            print ' selected ';
                                                                        } ?> value="page-header-dark">Dark</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-2">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <select class="form-control form-control-alt" name="header_mode" required>
                                                                <option <?php if (PageHeader == "page-header-static") {
                                                                            print ' selected ';
                                                                        } ?> value="page-header-static">Static</option>
                                                                <option <?php if (PageHeader == "page-header-fixed") {
                                                                            print ' selected ';
                                                                        } ?> value="page-header-fixed">Fixed</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-2">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <select class="form-control form-control-alt" name="body_content" required>
                                                                <option <?php if (MainContent == "main-content-narrowed") {
                                                                            print ' selected ';
                                                                        } ?> value="main-content-narrowed">Narrowed</option>
                                                                <option <?php if (MainContent == "main-content-boxed") {
                                                                            print ' selected ';
                                                                        } ?> value="main-content-boxed">Boxed</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-2">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <select class="form-control form-control-alt" name="theme">
                                                                ...
                                                                <option <?php if (Theme == "xwork.min-5.7.css") {
                                                                            print ' selected ';
                                                                        } ?> value="xwork.min-5.7.css">Blue v1</option>
                                                                <option <?php if (Theme == "xmodern.min-5.7.css") {
                                                                            print ' selected ';
                                                                        } ?> value="xmodern.min-5.7.css">Blue v2</option>
                                                                <option <?php if (Theme == "xdream.min-5.7.css") {
                                                                            print ' selected ';
                                                                        } ?> value="xdream.min-5.7.css">Blue v3</option>
                                                                <option <?php if (Theme == "xpro.min-5.7.css") {
                                                                            print ' selected ';
                                                                        } ?> value="xpro.min-5.7.css">Blue v4</option>
                                                                <option <?php if (Theme == "xeco.min-5.7.css") {
                                                                            print ' selected ';
                                                                        } ?> value="xeco.min-5.7.css">Green v1</option>
                                                                <option <?php if (Theme == "xinspire.min-5.7.css") {
                                                                            print ' selected ';
                                                                        } ?> value="xinspire.min-5.7.css">Green v2</option>
                                                                <option <?php if (Theme == "xsmooth.min-5.7.css") {
                                                                            print ' selected ';
                                                                        } ?> value="xsmooth.min-5.7.css">Purple</option>
                                                                <option <?php if (Theme == "xplay.min-5.7.css") {
                                                                            print ' selected ';
                                                                        } ?> value="xplay.min-5.7.css">Red</option>
                                                            </select>
                                                        </div>
                                                    </div>
