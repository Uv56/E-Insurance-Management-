            ...
            <ul class="nav-main">
                ...
                <li class="nav-main-item">
                    <a class="nav-main-link <?php if ($_GET['page'] == "sub-categories") {
                                                print ' active ';
                                            } ?>" href="staff?page=sub-categories">
                ...
                <li class="nav-main-item">
                    <a class="nav-main-link <?php if ($_GET['page'] == "ticket_categories") {
                                                print ' active ';
                                            } ?>" href="staff?page=ticket_categories">
