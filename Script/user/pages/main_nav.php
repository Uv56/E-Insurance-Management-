                ...
                <ul class="nav-main nav-main-horizontal nav-main-hover">
                    <li class="nav-main-item">
                        <a class="nav-main-link <?php if ($_GET['page'] == "dashboard") {
                                                    print ' active ';
                                                } ?>" href="user?page=dashboard">
                            <i class="nav-main-link-icon fa fa-location-arrow"></i>
                            <span class="nav-main-link-name">Dashboard</span>
                        </a>
                    </li>
                    <li class="nav-main-item">
                        <a class="nav-main-link nav-main-link-submenu <?php if ($_GET['page'] == "apply" || $_GET['page'] == "history") {
                                                                            print ' active ';
                        ...
                        <ul class="nav-main-submenu">
                            <li class="nav-main-item">
                                <a class="nav-main-link <?php if ($_GET['page'] == "apply") {
                                                            print ' active ';
                                                        } ?>" href="user?page=apply">
                                    <span class="nav-main-link-name">Apply Insurance</span>
                                </a>
                            </li>
                            <li class="nav-main-item">
                                <a class="nav-main-link <?php if ($_GET['page'] == "history") {
                                                            print ' active ';
                                                        } ?>" href="user?page=history">
                    ...
                    <li class="nav-main-item">
                        <a class="nav-main-link nav-main-link-submenu <?php if ($_GET['page'] == "generate" || $_GET['page'] == "history2") {
                                                                            print ' active ';
                                                                        } ?>" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="javascript:void(0);">
                        ...
                        <ul class="nav-main-submenu">
                            <li class="nav-main-item">
                                <a class="nav-main-link <?php if ($_GET['page'] == "generate") {
                                                            print ' active ';
                                                        } ?>" href="user?page=generate">
                                    <span class="nav-main-link-name">Generate</span>
                                </a>
                            </li>
                            <li class="nav-main-item">
                                <a class="nav-main-link <?php if ($_GET['page'] == "history2") {
                                                            print ' active ';
                                                        } ?>" href="user?page=history2">
